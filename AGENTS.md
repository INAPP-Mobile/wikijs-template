## RULE
1. Do not design railway template icon with texts in it, only graphical icon that follows existing icon style acceptable. og-image must have graphic and text.
